...
export default function Breed({ currentData, images }) {
	...
	return (
		<div className="px-4 lg:px-24">
			...
			<Navbar />
			<section className="flex flex-col lg:flex-row space-y-16 lg:space-x-24">
				<div className="relative w-full mx-auto lg:w-[371px] h-[371px] lg:ml-10">
					<Image
				...
				<div className="lg:w-3/4 mt-10 lg:mt-0 flex flex-col space-y-6 ">
